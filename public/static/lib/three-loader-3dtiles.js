...
import { GLTFLoader as GLTFLoader$1 } from './jsm/loaders/GLTFLoader.js';
    ...
    */
    static load(props) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tileset = new Tileset3D(tilesetJson, Object.assign(Object.assign({}, tileOptions), {
                loadOptions: Object.assign(Object.assign({}, loadersGLOptions), {
                    maxConcurrency: options.maxConcurrency, worker: options.worker, gltf: {
                        loadImages: false,
                    }, '3d-tiles': {
                        loadGLTF: false
                    }
